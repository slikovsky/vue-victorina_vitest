import { r as runCli } from "./bindings-Cpav0PNl.js";
import { i as resolvePlugins } from "./apis-BoXLniqX.js";
...
(async () => {
	...
	if (mode === "migrate:prettier") {
		await import("./migrate-prettier-BfVrZTrL.js").then((m) => m.runMigratePrettier());
		return;
	}
